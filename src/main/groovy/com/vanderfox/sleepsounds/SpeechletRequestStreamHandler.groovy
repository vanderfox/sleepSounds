 ...
 * "com.vanderfox.sleepsounds.SpeechletRequestStreamHandler" For this to work, you'll also need to build
...
public final class SpeechletRequestStreamHandler extends SpeechletRequestStreamHandler {
    ...
    public SpeechletRequestStreamHandler() {
        super(new SleepSoundsSpeechlet(), supportedApplicationIds);
    }
